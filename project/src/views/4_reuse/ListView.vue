  ...
  methods: {
    doSearch() {
      this.drinkList = [
        ...
        { drinkId: '3', drinkName: '사이다', price: 500, qty: 1 },
        { drinkId: '4', drinkName: '포도주스', price: 1000, qty: 1 },
        { drinkId: '5', drinkName: '물', price: 400, qty: 1 },
        { drinkId: '6', drinkName: '커피', price: 300, qty: 1 },
        { drinkId: '7', drinkName: '에이드', price: 2200, qty: 1 }
      ]
    },
    doDelete() {
